...
function createNewRepository(){
	...
	RepositoryService.createRepository(repository, $('#pmSAPCode').val() , $('#spocSAPCode').val() , $('#alternateApproverSapCode').val() , $('#serviceStartDate').val()   ,  $('#serviceEndDate').val()  , function(p){
		...
		window.location.href="/toolsautomation/svn/repository/edit?id="+p.id;
...
function checkRepositoryAvailability(obj){
	RepositoryService.checkRepositoryAvailability( obj.value ,  function(p){
		
		if(!p){
			alert("Repository already exist. Please give some different name .");
			obj.value = '';
		}
		
	});
}
function fetchProjectData(projectCode){
	
	RepositoryService.fetchProjectData( projectCode ,  function(p){
		
			var result = JSON.parse(p);
			dwr.util.setValues(result);
	
		
	});
} 
function fetchLinkedProjectDetails(linkedProjectSapCode){
	var sapCode = $("#projectSapCode").val();

	RepositoryService.fetchLinkedProjectDetails( linkedProjectSapCode , sapCode ,  function(p){		
		var result = JSON.parse(p);
		dwr.util.setValues(result);	
	});
}
...
<div>
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <!-- <li role="presentation" class="disabled"><a onclick="populateDefinationTable()" href="#defineTab" aria-controls="defineTab" role="tab" data-toggle="tab" id="switchDefination">
    	<span class="badge" style="position: relative; float: left;">Step-2</span>&nbsp;&nbsp;DEFINATION</a>
    </li>
    <li role="presentation" class="disabled"><a onclick="getDataForAssignationTab()" href="#assignationTab" aria-controls="assignationTab" role="tab" data-toggle="tab" id="switchAssignation">
    	<span class="badge" style="position: relative; float: left;">Step-3</span>&nbsp;&nbsp;ASSIGNATION</a>
    </li>
    <li role="presentation" class="disabled"><a onclick="populatConfirmationTab()" href="#confirmationTab" aria-controls="confirmationTab" role="tab" data-toggle="tab" id="switchConfirmation">
...
<form action="<%= request.getContextPath() %>/svn/restoration/submitforapproval" id="SARTabForm" data-toggle="validator" role="form" novalidate="false"> 
	...
	<tr>
		...
		<table border="0" style="width: 90%; height: 400px; margin-left: 20px;" >
			...
			<tr>
				<td width="47%"><label for="projectSapCode">&nbsp;&nbsp;&nbsp;&nbsp;Project Code</label></td>			
				<td><input type="text" class="form-control" id="projectSapCode" onblur="fetchProjectData(this.value)" required></td>
			</tr>
			<tr>
			...
			<tr>
				<td><label for="pmSapCode">&nbsp;&nbsp;&nbsp;&nbsp;PM Sap Code</label></td>			
				<td><input type="text" class="form-control" id="pmSapCode" ></td>
			</tr>
			<tr>
				<td><label for="pmName">&nbsp;&nbsp;&nbsp;&nbsp;PM Name</label></td>			
				<td><input type="text" class="form-control" id="pmName" ></td>
			</tr>
			<tr>
				<td><label for="pmEmail">&nbsp;&nbsp;&nbsp;&nbsp;PM Email</label></td>			
				<td><input type="text" class="form-control" id="pmEmail" ></td>
			</tr>
			<tr>
				<td><label for="lobName">&nbsp;&nbsp;&nbsp;&nbsp;LOB Name</label></td>			
				<td><input type="text" class="form-control" id="lobName" ></td>
			</tr>
			<tr>
				<td><label for="duName">&nbsp;&nbsp;&nbsp;&nbsp;DU Name</label></td>			
				<td><input type="text" class="form-control" id="duName" ></td>
			</tr>
			<tr>
				<td><label for="sduName">&nbsp;&nbsp;&nbsp;&nbsp;SDU Name</label></td>			
				<td><input type="text" class="form-control" id="sduName" ></td>
			</tr>
			<tr>
				<td><label for="linkedProjectSapCode">&nbsp;&nbsp;&nbsp;&nbsp;Linked Project Sap Code</label></td>			
				<td><input type="text" class="form-control" id="linkedProjectSapCode" onblur="fetchLinkedProjectDetails(this.value)" ></td>
			</tr>
			<tr>
				<td><label for=""noOfHClCMToolUser"">&nbsp;&nbsp;&nbsp;&nbsp;No of HCL CM Tool User</label></td>			
				<td><input type="text" class="form-control" id="noOfHClCMToolUser" ></td>
			</tr>
			<tr>
				<td><label for="noOfExternalCMToolUser">&nbsp;&nbsp;&nbsp;&nbsp;No of External CM Tool User</label></td>			
				<td><input type="text" class="form-control" id="noOfExternalCMToolUser" ></td>
			</tr>
			<tr>
...
<br><button class="btn btn-primary" type="submit" >NEXT</button>
...
$('#SARTabForm').validator().on('submit', function (e) {
