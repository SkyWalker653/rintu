...
import tools.automation.web.UserController;
...
privileged aspect UserController_Roo_Controller {
    ...
    void UserController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("user_createdon_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
    
    void UserController.populateEditForm(Model uiModel, User user) {
        uiModel.addAttribute("user", user);
        addDateTimeFormatPatterns(uiModel);
        uiModel.addAttribute("pmsmartaccessrequests", PmsmartAccessRequest.findAllPmsmartAccessRequests());
        uiModel.addAttribute("pmsmartprojects", PmsmartProject.findAllPmsmartProjects());
        uiModel.addAttribute("repositorygroupusermaps", RepositoryGroupUserMap.findAllRepositoryGroupUserMaps());
        uiModel.addAttribute("repositoryusermaps", RepositoryUserMap.findAllRepositoryUserMaps());
        uiModel.addAttribute("svnrepositorys", SvnRepository.findAllSvnRepositorys());
        uiModel.addAttribute("svnrequestfilerestorations", SvnRequestFileRestoration.findAllSvnRequestFileRestorations());
        uiModel.addAttribute("svnrequestrepositoryaccesses", SvnRequestRepositoryAccess.findAllSvnRequestRepositoryAccesses());
        uiModel.addAttribute("svnrequestrepositorymigrations", SvnRequestRepositoryMigration.findAllSvnRequestRepositoryMigrations());
        uiModel.addAttribute("svnrequestrepositoryrestorations", SvnRequestRepositoryRestoration.findAllSvnRequestRepositoryRestorations());
        uiModel.addAttribute("userrolemaps", UserRoleMap.findAllUserRoleMaps());
    }
