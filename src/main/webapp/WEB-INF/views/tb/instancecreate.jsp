...
<form action="<%= request.getContextPath() %>/tb/restoration/submitforapproval" id="SARTabForm" data-toggle="validator" role="form" novalidate="false"> 
	...
	<tr>
		...
		<table border="0" style="width: 90%; height: 400px; margin-left: 20px;" >
			...
			<tr>
				...
				<td><input type="text" class="form-control" id="projectSapCode" required></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" class="form-control" id="repositoryName" onblur="checkRepositoryAvailability(this)"></td>
			</tr>
			<tr>
